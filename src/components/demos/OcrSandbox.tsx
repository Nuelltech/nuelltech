    ...
    <div className="w-full max-w-5xl mx-auto bg-brand-card rounded-2xl border border-brand-border overflow-hidden box-glow glass">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] border-b border-brand-border">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 p-6 gap-6">
          ...
          <div className="bg-[#05070D] rounded-xl border border-brand-border p-5 relative overflow-hidden flex flex-col justify-between h-[340px] text-[10px]">
          ...
          <div className="flex flex-col justify-between h-[340px]">
            {/* Terminal logs */}
            <div className="bg-[#05070D] border border-brand-border rounded-xl p-4 flex-1 overflow-y-auto font-mono text-[9px] text-[#A6E22E] flex flex-col gap-1.5 scrollbar-thin">
              ...
              {scanStatus === 'done' && impactData && (
                ...
                >
                  <div className="flex items-center gap-2 mb-1.5">
                    {impactData.type === 'success' ? (
                      <CheckCircle className="w-4 h-4 text-brand-ok" />
                    ) : (
                      <AlertTriangle className={`w-4 h-4 ${impactData.type === 'danger' ? 'text-brand-risk' : 'text-brand-warn'}`} />
                    )}
                    <h5
                  ...
                  <p className="text-[10px] text-brand-ink-dim leading-relaxed mb-2">
                    {impactData.desc}
                  </p>
                  <div className="text-[9px] font-mono text-brand-ink font-semibold border-t border-brand-border/40 pt-1.5 mt-1.5">
